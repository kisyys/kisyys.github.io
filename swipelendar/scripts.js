...
function dayview(number, number2) {
    ...
    for(let hour = 1; hour <= 24; hour++) {
        ...
        if(now+1==hour && number==today && month == d2.getMonth()+1 && year == d2.getFullYear()) {
            ...
            etasks.insertAdjacentHTML("beforeend", `<div class="hour"${` id="divhourtask` + hour + `";>` + `<p style="color:black";>` + previous + ":00" + "-" + hour + ":00" + "  " + "</p>" + `<a href="https://kisyys.github.io/kasvis/">Plan a dinner</a>`}</div>`);
