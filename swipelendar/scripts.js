...
function dayview(number, number2) {
    ...
    topic.insertAdjacentHTML("beforeend", `<div class="topic";> ${ "<b>" +  dayName2 + " - Test20" +  "</b>"}</div>`);
    ...
    function done(numberx) {
        ...
        //history2[parseInt(old2)+parseInt(t3[0])] = `<p style="color:black";>` + t2[0] + "  " + "</p>" +  "<del>" + t2[1] + "</del>";
        //localStorage.setItem("day_history", JSON.stringify(history2)); 
