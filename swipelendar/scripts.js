...
if(!localStorage.getItem("day_history"))  {
    ...
    var history2 = localStorage.getItem("day_history");
}
...
function dayview(number, number2) {
    ...
    topic.insertAdjacentHTML("beforeend", `<div class="topic";> ${ "<b>" +  dayName2 + " - Test17" +  "</b>"}</div>`);
    ...
    if(old>0) {
        ...
        localStorage.setItem("day_history", history2.push(what_day));
        ...
        for(let hour = 1; hour <= 24; hour++) {
            ...
            if(now+1==hour && number==today && month == d2.getMonth()+1 && year == d2.getFullYear()) {
                ...
                x = hour;
                localStorage.setItem("day_history", history2.push(`"beforeend", <div class="now"${` id="divhour` + hour + `";>` + `<p style="color:black";>` + "<b>"+ previous + ":00" + "-" + hour + ":00" + "  " +  "<br>" + "Now" + "</b>" + "</p>"}</div>`));
            }
                ...
                localStorage.setItem("day_history", history2.push(` <div class="hourdinner"${` id="divhourtask` + hour + `";>` + `<p style="color:black";>` + previous + ":00" + "-" + hour + ":00" + "  " + "</p>" + `<a style="color:blue" href="https://kisyys.github.io/kasvis/">Plan a dinner</a>`}</div>`));
            }
                ...
                list_divhourtasks.push("divhourtask" + hour);
                localStorage.setItem("day_history", history2.push(` <div class="hourhard"${` id="divhourtask` + hour + `";>` + `<p style="color:black";>` + previous + ":00" + "-" + hour + ":00" + "  " + "</p>" + random4}</div>`));  
            }
                ...
                list_divhourtasks.push("divhourtask" + hour);
                localStorage.setItem("day_history", history2.push(` <div class="houreasy"${` id="divhourtask` + hour + `";>` + `<p style="color:black";>` + previous + ":00" + "-" + hour + ":00" + "  " + "</p>" +  random2}</div>`));
            }
                ...
                localStorage.setItem("day_history", history2.push(` <div class="hour"${` id="divhour` + hour + `";>` + `<p style="color:black";>` + previous + ":00" + "-" + hour + ":00" + "  " + "</p>"}</div>`));  
            }
    ...
    function done(numberx) {
        ...
        var t3 = t.split("-");
        //console.log(old2+t3[0]);
        localStorage.setItem("day_history", history2[old2+t3[0]] = `<p style="color:black";>` + t2[0] + "  " + "</p>" +  "<del>" + t2[1] + "</del>"); 
