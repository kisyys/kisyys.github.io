...
function dayview(number, number2) {
    ...
    for(let hour = 1; hour <= 24; hour++) {
        ...
        if(now+1==hour && number==today && month == d2.getMonth()+1 && year == d2.getFullYear()) {
            ...
            etasks.insertAdjacentHTML("beforeend", `<div class="hour"${` id="divhourtask` + hour + `";>` + previous + ":00" + "-" + hour + ":00 <br>" + `<a href="https://kisyys.github.io/kasvis/">Plan a dinner</a>`}</div>`);
            ...
            etasks.insertAdjacentHTML("beforeend", `<div class="hour"${` id="divhourtask` + hour + `";>` + previous + ":00" + "-" + hour + ":00 <br>" + `<p style="color:red";>` + random4 + "</p>"}</div>`);
            list_divhourtasks.push("divhourtask" + hour);  
        }
            ...
            etasks.insertAdjacentHTML("beforeend", `<div class="hour"${` id="divhourtask` + hour + `";>` + previous + ":00" + "-" + hour + ":00 <br>" + `<p style="color:green";>` + random2 + "</p>"}</div>`);
            list_divhourtasks.push("divhourtask" + hour);  
        }
    ...
    //divhourtask18.addEventListener('touchstart', handleTouchStart, false);        
    //divhourtask18.addEventListener('touchmove', handleTouchMove, false);
            ...
            if ( xDiff > 0 ) {
                ...
                for(let i = 0; i<list_divhourtasks.length;i++) {
                    ...
                    if(display == 1 && !content.includes("Done"))  {                
                        score++;
                        list_divhourtasks[i] + `.innerHTML += " - Done";`
