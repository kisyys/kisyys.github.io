...
function addTasks(){
    ...
    const rtasks = document.querySelector("#tasks1");
    ...
    const stasks = document.querySelector("#tasks1");
...
function dayview(number, number2) {
    ...
    topic.insertAdjacentHTML("beforeend", `<div class="topic";> ${ "<b>" +  dayName2 + " - Test29" +  "</b>"}</div>`);
