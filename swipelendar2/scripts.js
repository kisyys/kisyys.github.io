...
function dayview(number, number2) {
    ...
    topic.insertAdjacentHTML("beforeend", `<div class="topic";> ${ "<b>" +  dayName2 + " - Test34" +  "</b>"}</div>`);
...
function back(number) {
    ...
    addtasks.insertAdjacentHTML("beforeend", `<p id="p1" style="text-align:center" onclick="tasks()"> <b> Tasks </b> </p>`);
