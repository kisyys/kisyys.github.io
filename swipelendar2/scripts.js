...
function addTasks(){
    ...
    document.getElementById("month_year").innerHTML = "Add tasks";
    ...
    <form>
		...
		<br>
        <button type="button" onclick="buttonTask()">Add</button>
	</form>
...
function showLists() {
    ...
    lists.insertAdjacentHTML("beforeend", `<label for="list1">List of easy tasks:</label> <br> <select id="list1"></select> <br><br>`);
    ...
    lists.insertAdjacentHTML("beforeend", `<button type="button" onclick="deleteTask(1)">Delete</button> <br><br><br>`);

    lists.insertAdjacentHTML("beforeend", `<label for="list2">List of hard tasks:</label> <br> <select id="list2"></select> <br><br>`);
    ...
    lists.insertAdjacentHTML("beforeend", `<button type="button" onclick="deleteTask(2)">Delete</button> <br><br><br>`);

    lists.insertAdjacentHTML("beforeend", `<label for="list3">List of special tasks:</label> <br> <select id="list3"></select> <br><br>`);
    ...
    lists.insertAdjacentHTML("beforeend", `<button type="button" onclick="deleteTask(3)">Delete</button> <br><br><br>`);
...
function dayview(number, number2) {
    ...
    topic.insertAdjacentHTML("beforeend", `<div class="topic";> ${ "<b>" +  dayName2 + " - Test31" +  "</b>"}</div>`);
...
function back(number) {
    ...
    addtasks.insertAdjacentHTML("beforeend", `<p id="p1" style="text-align:center" onclick="addTasks()"> <b> Add tasks </b> </p>`);
