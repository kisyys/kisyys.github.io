...
function addTasks(){
    ...
    const adding = document.querySelector("#app-calendar1");
    adding.insertAdjacentHTML("beforeend", `
...
function buttonTask() {
    if(document.getElementById("etasks").value=="") {
        ...
        addingtoTasklist(document.getElementById("etasks").value,0);
    }
    ...
    if(document.getElementById("htasks").value=="") {
        ...
        addingtoTasklist(document.getElementById("htasks").value,1);
    }
}

function addingtoTasklist(task, number) {
    if(number==0) {
...
function dayview(number, number2) {
    ...
    topic.insertAdjacentHTML("beforeend", `<div class="topic";> ${ "<b>" +  dayName2 + " - Test27" +  "</b>"}</div>`);
    ...
    if(old>0) {
        ...
        for(let i = 0; i<list_divhourtasks_history.length;i++) {
            ...
            //console.log(list_divhourtasks_history[index1]);
            index1++;
        ...
        for(let hour = 1; hour <= 24; hour++) {
            ...
            else if(10<hour && 21>=hour && random3==0) {
            ...
            else if(10<hour && 21>=hour && random1==0) {
